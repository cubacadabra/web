...
const sectionsSourcePath = path.join(aboutDirectory, "about-sections.html");
...
const createPage = (source, sectionsSource, routeId, route) => {
...
${createHead(route)}
  <body class="about-page" data-about-route="${routeId}">
    <!-- Generated by scripts/build-about-pages.js. Edit about/index.html, about/about-sections.html, and about/about-routes.js. -->
