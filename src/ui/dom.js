...
export function getDomElements() {
  ...
  return {
    ...
    settingsAgeForm: getElement("#settings-age-form"),
    settingsDobInput: getElement("#settings-dob-input"),
    settingsAgeStatus: getElement("#settings-age-status"),
    settingsAgeCancelButton: getElement("#settings-age-cancel-button"),
