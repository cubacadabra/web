...
export function getDomElements() {
  ...
  return {
    ...
    settingsRoomHint: getElement("#settings-room-hint"),
    settingsRoomPanel: getElement("#settings-room-panel"),
    settingsUsernameOption: getElement("#settings-username-option"),
    settingsUsernameValue: getElement("#settings-username-value"),
    ...
    settingsLeaveButton: getElement("#settings-leave-button"),
