...
export function getDomElements() {
  ...
  return {
    ...
    characterShowcaseLauncher: getElement("#character-showcase-launcher"),
    characterShowcasePanel: getElement("#character-showcase-panel"),
    characterShowcaseClose: getElement("#character-showcase-close"),
    characterShowcaseStatus: getElement("#character-showcase-status"),
    characterShowcaseSpecies: getElement("#character-showcase-species"),
    characterShowcaseExpressions: getElement("#character-showcase-expressions"),
    characterShowcaseExpressionCount: getElement("#character-showcase-expression-count"),
    characterShowcaseWave: getElement("#character-showcase-wave"),
    characterShowcaseOutfits: getElement("#character-showcase-outfits"),
